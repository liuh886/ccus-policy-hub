...
| Item                                  | Detail                                                                                                                                                                                                                                                      |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Facility news — Phase E (remaining)   | Extend curated coverage beyond the 158 facilities already enriched (operational ≥1 Mtpa + under-construction ≥1 Mtpa + planned ≥2.5 Mtpa) toward the full planned/under-construction set, as capacity warrants. See `agent/ccus-ai-agent/METHODOLOGY.md` §9 |
