...
- `agent/ccus-ai-agent/db/ccus_master.sqlite` is the SINGLE Source of Truth.
...
- Keep `agent/ccus-ai-agent/governance/` root limited to core files only (see `agent/ccus-ai-agent/governance/README.md`).
