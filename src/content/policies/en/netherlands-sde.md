...
## Overview
A major Dutch subsidy scheme using a CfD model, where the government pays the delta between project costs and EU ETS prices, critical for large-scale CCS financial viability.
