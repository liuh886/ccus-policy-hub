...
| Item                                  | Detail                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Facility news — Phase D (remaining)   | Expand curated `agent-research` coverage beyond the 17 operational ≥1 Mtpa facilities already enriched (e.g. large under-construction projects), and act on the first link-health report (150 dead of 1,887 URLs). (Ingest mechanism, titles/dates fetch, coverage metric, and link-rot checker shipped.) See `agent/ccus-ai-agent/METHODOLOGY.md` §9 |
