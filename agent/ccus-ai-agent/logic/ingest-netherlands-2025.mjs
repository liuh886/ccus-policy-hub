...
async function ingest() {
  ...
  try {
    ...
    const desc_en =
      "The Netherlands published its CDR Roadmap in 2025, targeting 20-25 Mt of CO2 removals by 2040. The CCUS framework integrates with the Porthos project (operational 2026) and utilizes a CO2 levy for industry, aligned with EU's industrial carbon management goals.";
    const desc_zh =
      '荷兰于2025年发布了碳消除 (CDR) 路线图，目标到2040年实现 2000-2500 万吨的二氧化碳消除。CCUS 框架与 Porthos 项目（2026年运营）相结合，并利用工业二氧化碳征税，与欧盟的工业碳管理目标保持一致。';
    ...
    db.run(
      ...
      [
        policyId,
        'en',
        'Netherlands Carbon Dioxide Removal (CDR) Roadmap 2025',
        desc_en,
    ...
    for (const s of scores) {
      db.run(
        ...
        [
          ...
          s[1],
          'High',
          'Highly integrated industrial hub approach and CDR strategy.',
        ]
      );
    }
