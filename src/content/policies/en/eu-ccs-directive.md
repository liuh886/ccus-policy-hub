---
{
  "analysis": {
    "incentive": {
      "auditNote": "",
      "citation": "Article 12 & 13",
      "evidence": "Enables MS to provide aid and exempts stored CO2 from ETS surrendering.",
      "label": "Indirect (via ETS)",
      "score": 40
    },
    "market": {
      "auditNote": "",
      "citation": "Article 12",
      "evidence": "Explicitly linked to EU ETS Directive for emission accounting.",
      "label": "ETS Linkage",
      "score": 60
    },
    "mrv": {
  ...
  "id": "eu-ccs-directive",
  "impactAnalysis": {
    "economic": "The 20-year liability transfer solves the otherwise uninsurable tail-risk of geological storage, creating the long-term certainty required for project financing.",
    "environmental": "Guarantees the absolute permanence of sequestration across the Union, underpinning the environmental credibility of the EU Emissions Trading System (ETS).",
    "technical": "Mandates state-of-the-art monitoring and reservoir characterization; the 2024 updates further accommodate novel monitoring technologies and sub-surface modeling."
  },
  "interpretation": "",
