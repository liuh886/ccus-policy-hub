...
- `agent/ccus-ai-agent/governance/0_GOVERNANCE.md`
- `agent/ccus-ai-agent/governance/OPERATING_RULES_AGENT.md`
- `agent/ccus-ai-agent/governance/SKILL_MASTER.md`
- `agent/ccus-ai-agent/governance/field_mapping_sqlite.md`
- `agent/ccus-ai-agent/governance/audit_thresholds.json`
- `agent/ccus-ai-agent/governance/IEA CCUS Projects Database 2025.xlsx`

## Core Directories

- `agent/ccus-ai-agent/db/`：SQLite SSOT 与 schema
- `agent/ccus-ai-agent/governance/reports/`：审计与统计产物（可覆盖）
- `agent/ccus-ai-agent/governance/archive/`：历史方案、旧报告、阶段性文档
