...
export const ui = {
  zh: {
    ...
    'policy.category.Incentive': '经济激励',
    'policy.category.Regulatory': '法律监管',
    'policy.category.Market': '市场机制',
    'policy.category.Strategic': '战略引导',
    'policy.category.Technical': '技术标准',
  ...
  en: {
    ...
    'policy.category.Incentive': 'Incentive',
    'policy.category.Regulatory': 'Regulatory',
    'policy.category.Market': 'Market',
    'policy.category.Strategic': 'Strategic',
    'policy.category.Technical': 'Technical',
