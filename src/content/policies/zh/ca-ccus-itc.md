---
{
  ...
  "category": "法律监管",
  "country": "加拿大",
  "description": "## 政策概览\r \r 加拿大 CCUS 投资税收抵免 (CCUS ITC) 是加拿大联邦政府为对冲美国 45Q 政策竞争而推出的核心激励工具。该政策为符合条件的 CCUS 资本支出提供最高 50% 至 60% 的税收抵免（其中大气直接捕集项目抵免比例最高）。与传统的财政补贴不同，ITC 通过直接抵减企业应纳税额，显著改善了大型捕集设施（如油砂矿和化肥厂）的初期现金流。为了确保环境保真度，加拿大法律要求享受抵免的项目必须通过严格的 MRV 审核，且明确排除了将捕集的二氧化碳用于提高石油采收率 (EOR) 的项目获得抵免的资格，体现了加拿大推动永久地质封存的政策导向。",
  "evolution": {
    "clusters": [
  ...
  "id": "ca-ccus-itc",
  "impactAnalysis": {
    "economic": "提供高达 50%-60% 的可退还税收抵免，显著降低项目资本开支 (CAPEX)，并允许与省级补贴（如阿尔伯塔省 ACCIP）叠加。",
    "environmental": "作为加拿大 2030 减排计划的经济引擎，支撑油砂、钢铁、水泥等重工业的深度脱碳。",
    "technical": "通过阶梯式抵免率显式激励直接空气捕集 (DAC, 60%) 与盐水层封存，体现了对高价值脱碳路径的技术偏好。"
  },
  ...
  "regulatory": {
    ...
    "cross_border_rules": "",
    "financial_assurance": "",
    "liability_period": "省政府承担，各省周期不同",
    "liability_transfer": "",
    "permitting_lead_time": "3-5 年",
    "pore_space_rights": ""
  },
  "relatedFacilities": [
    "1036",
...
加拿大 CCUS 投资税收抵免 (CCUS ITC) 是加拿大联邦政府为对冲美国 45Q 政策竞争而推出的核心激励工具。该政策为符合条件的 CCUS 资本支出提供最高 50% 至 60% 的税收抵免（其中大气直接捕集项目抵免比例最高）。与传统的财政补贴不同，ITC 通过直接抵减企业应纳税额，显著改善了大型捕集设施（如油砂矿和化肥厂）的初期现金流。为了确保环境保真度，加拿大法律要求享受抵免的项目必须通过严格的 MRV 审核，且明确排除了将捕集的二氧化碳用于提高石油采收率 (EOR) 的项目获得抵免的资格，体现了加拿大推动永久地质封存的政策导向。
