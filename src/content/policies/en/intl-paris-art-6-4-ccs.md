---
{
  'analysis':
    {
      'incentive':
        {
          'auditNote': '',
          'citation': 'Standard for Carbon Removals, 2024',
          'evidence': 'Enables host countries to monetize CCS removals via international markets.',
          'label': 'Global Credit Access',
          'score': 65,
        },
      'market':
        {
          'auditNote': '',
          'citation': 'Article 6.4 trading rules',
          'evidence': 'The ultimate mechanism for sovereign and corporate carbon trade.',
          'label': 'Global Interoperability',
          'score': 100,
        },
      'mrv':
        {
          'auditNote': '',
          'citation': 'SBM 014 Report',
          'evidence': 'Highest level of monitoring stringency required for ITMO issuance.',
          'label': 'Universal MRV',
          'score': 95,
        },
      'statutory':
        {
          'auditNote': 'The definitive global M-dimension anchor.',
          'citation': 'CMA.6 Endorsement',
          'evidence': 'The supreme international framework for carbon crediting under the UN.',
          'label': 'Global Legal Standard',
          'score': 85,
        },
      'strategic':
        {
  ...
  'evolution':
    {
      ...
      'supersedes': ['clean-development-mechanism-legacy'],
    },
  'id': 'intl-paris-art-6-4-ccs',
  'impactAnalysis':
    {
      'economic': "Eliminates methodological risks through 'Corresponding Adjustments,' making A6.4ERs a premium asset class for sovereign buyers and significantly lowering the cost of capital for cross-border Hubs.",
      'environmental': 'Acts as the global guarantor of environmental integrity for sequestered CO2, ensuring that international transfers result in real, additional, and permanent removals.',
      'technical': "The 2024 CDR guidelines enforce risk-based sub-surface characterization and long-term monitoring, standardizing the 'reversal' accounting logic globally.",
    },
  ...
  'source': 'UNFCCC',
  'status': 'Active',
  'title': 'Paris Agreement Article 6.4 Mechanism (CCS & CDR Standards)',
